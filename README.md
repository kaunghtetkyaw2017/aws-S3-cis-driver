...
| ``` |
|  |
| 6. Attach `AmazonS3CSIDriverPolicy` ARN the previously created policy to the role: |
|  |
| ```jsx |
...
| ``` |
|  |
| 7. Associate this role with the service account used by the CSI driver: |
|  |
| ```jsx |
...
| ``` |
|  |
| 8. Add the Amazon S3 CSI add-on using `eksctl` or `aws cli:` |
|  |
| ```jsx |
| eksctl create addon \ |
...
| volumeHandle: uat-bk  #bucket name |
| volumeAttributes: |
| bucketName: uat-bk   #bucket name |
| region: ap-southeast-1 |
| ``` |
|  |
